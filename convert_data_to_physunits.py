"""
This code processes the LSPE geophone data from uncompressed volts to physical units (nm/s)
...
def read_sac(flist, ad_plots, day, filename, output_folder):
    """
    ...
    if ad_plots:
        ...
        fig.savefig(f'{output_folder}additional_images/{day}/{filename}_original.png')
...
def rm_freq_resp(df, ad_plots, day, filename, output_folder, resp_f, resp_vals, lowcut, highcut, bp_order, wl_cutoff):
    ...
    if not os.path.exists(f'{output_folder}images/p0_original_instrument_response.png'):
        ...
        fig3.savefig(f'{output_folder}images/original_instrument_response.png')
        # plt.savefig(f'{output_folder}images/original_instrument_response.eps')
    ...
    for geophone_ind in np.arange(4):
        ...
        if ad_plots:
            ...
            fig4.savefig(f'{output_folder}additional_images/{day}/{filename}_interpolated_resp.png')
            # plt.savefig(f'{output_folder}additional_images/{day}/{filename}_interpolated_resp.eps')
        ...
        if ad_plots:
            ...
            fig5.savefig(f'{output_folder}additional_images/{day}/{filename}_geo{geophone_ind + 1}_filtered.png')
            # plt.savefig(f'{output_folder}additional_images/{day}/{filename}_geo{geophone_ind + 1}_filtered.eps')
        ...
        if not os.path.exists(f'{output_folder}images/0_p1_wl_correction.png'):
            fig6.savefig(f'{output_folder}images/p1_wl_correction.png')
            plt.savefig(f'{output_folder}images/p1_wl_correction.eps')

        # -----------------------------------------------
        # Plot the real, imaginary, and absolute parts of the insturment response
        if not os.path.exists(f'{output_folder}images/p2_full_instrument_response.png'):
            ...
            fig7.savefig(f'{output_folder}images/full_instrument_response.png')
            # plt.savefig(f'{output_folder}images/full_instrument_response.eps')
        ...
        if not os.path.exists(f'{output_folder}images/p3_instrument_response_inverted_log.png'):
            ...
            fig8.savefig(f'{output_folder}images/p3_instrument_response_inverted_log.png')
            plt.savefig(f'{output_folder}images/p3_instrument_response_inverted_log.eps')

        if not os.path.exists(f'{output_folder}images/p4_instrument_response_inverted_linear.png'):
            ...
            fig9.savefig(f'{output_folder}images/instrument_response_inverted_linear.png')
            # plt.savefig(f'{output_folder}images/instrument_response_inverted_linear.eps')
        ...
        if ad_plots:
            ...
            fig10.savefig(f'{output_folder}images/{day}/{filename}_geo{geophone_ind + 1}_detrended_data.png')
            # plt.savefig(f'{output_folder}images/{day}/{filename}_geo{geophone_ind + 1}_detrended_data.eps')
            # plt.close()
        ...
        fig11.savefig(f'{output_folder}images/{day}/{filename}_geo{geophone_ind + 1}_resp_rm.png')
        # plt.savefig(f'{output_folder}images/{day}/{filename}_geo{geophone_ind + 1}_resp_rm.eps')
...
def process_data(input_folder, unique_dayhour, ad_plots, output_folder, resp_f, resp_vals, lowcut, highcut, bp_order,
    ...
    df = read_sac(flist, ad_plots, day, filename, output_folder)
...
def main():
    ...
    input_folder = 'D:/LSPE_sac/'
    rundir = 'C:/Users/Francesco/Dropbox/NASA_codes/publication/'
    ...
    output_folder = 'D:/LSPE_converted/'
    ...
    for dayfolder in daylist:
        ...
        if not os.path.exists(f'{output_folder}images/{daystr}'):
            os.mkdir(f'{output_folder}images/{daystr}')
    ...
    if additional_plots:
        add_image_folder = f'{output_folder}additional_images/'
        if not os.path.exists(f'{output_folder}additional_images/'):
            os.mkdir(f'{output_folder}additional_images/')
        for dayfolder in daylist:
            daystr = os.path.basename(dayfolder)
            if not os.path.exists(f'{output_folder}additional_images/{daystr}'):
                os.mkdir(f'{output_folder}additional_images/{daystr}')
